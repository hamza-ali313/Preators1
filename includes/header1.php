                            ...
                            <div class="dropdown-menu MegaMenu_menu">
                                <div class="row">
                                    <div class="col-12 col-lg-4 col-md-6">
                                        ...
                                        <ul class="my-4">
                                            <li>
                                                <a href="custom_web_dev.php"><i class="fa-brands fa-php"></i>Custom
                                                    Web Development
                                                </a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-12 col-lg-3 col-md-6">
                                        ...
                                        <ul class="my-4">
                                            ...
                                            <li>
                                                <a href="react-native.php"><i class="fa-brands fa-react"></i>
                                                    React Native App Development
                                                </a>
                                            </li>
                                            <li>
                                                <a href="android_dev.php"><i class="fa-brands fa-android"></i>
                                                    Android App Development
                                                </a>
                                            </li>
                                            <li>
                                                <a href="ios.php"><i class="fa-brands fa-app-store-ios"></i>
                                                    iOS App Development
                                                </a>
                                            </li>
                                            <li>
                                                <a href="flutter.php"><i class="fa-solid fa-florin-sign"></i>
                                                    Flutter App Development
                                                </a>
                                            </li>
                                            <li>
                                                <a href="custom_mobile.php"><i class="fa-brands fa-react"></i>
                                                    Native App Development
                                                </a>
                                            </li>
                                            <li>
                                                <a href="hybrid-app.php"><i class="fa-solid fa-layer-group"></i>
